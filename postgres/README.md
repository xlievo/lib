...
slave: docker run --restart=always -d --name db2 -e POSTGRES_USER=root -p 5920:5432 -v /root/workspace/db2:/var/lib/postgresql/data -v /root/workspace/pg_log:/log -v /root/workspace/pg_backups:/backups -e SHOST=172.17.0.1 -e SPORT=5920 -e SPASSWORD=e3980c76 xlievo/postgres:latest -c 'shared_buffers=256MB' -c 'max_connections=1000'
